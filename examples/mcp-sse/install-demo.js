...
function main() {
  ...
  upsertBy(config.mcp_servers, (s) => s && s.name === MCP_NAME, {
    name: MCP_NAME,
    url: MCP_URL,
  });
  ...
  process.stdout.write(
    `Installed remote demo command ai.text.summarize_remote and MCP '${MCP_NAME}' in ${CACHE_FILE}\n`,
  );
}

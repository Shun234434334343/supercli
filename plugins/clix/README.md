...
This plugin is a hybrid harness for `clix`: it indexes the upstream `SKILL.md` and `README.md` into the local skill-doc catalog and exposes a curated set of safe read-only wrappers.
